...
from legged_lab.envs.x2ultra.x2ultra_env import X2UltraEnv
from legged_lab.envs.x2ultra.x2ultra_config import (
    X2UltraFlatAgentCfg,
    X2UltraFlatEnvCfg,
    X2UltraRoughAgentCfg,
    X2UltraRoughEnvCfg,
)
from legged_lab.envs.x2ultra.x2ultra_dwaq_env import X2UltraDwaqEnv
from legged_lab.envs.x2ultra.x2ultra_dwaq_config import (
    X2UltraDwaqAgentCfg,
    X2UltraDwaqEnvCfg,
)
...
task_registry.register("x2ultra_rough", X2UltraEnv, X2UltraRoughEnvCfg(), X2UltraRoughAgentCfg())
task_registry.register("x2ultra_dwaq", X2UltraDwaqEnv, X2UltraDwaqEnvCfg(), X2UltraDwaqAgentCfg())
